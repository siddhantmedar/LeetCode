...
<pre style="position: relative;"><strong>Input:</strong> nums1 = [1,0,0,2,3], nums2 = [0,3,0,4,0]
...
<pre style="position: relative;"><strong>Input:</strong> nums1 = [0,1,0,0,0], nums2 = [0,0,0,0,2]
...
<pre style="position: relative;"><strong>Input:</strong> nums1 = [0,1,0,0,2,0,0], nums2 = [1,0,0,0,3,0,4]
