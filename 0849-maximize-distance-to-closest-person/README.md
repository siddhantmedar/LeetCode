...
<pre style="position: relative;"><strong>Input:</strong> seats = [1,0,0,0,1,0,1]
...
<pre style="position: relative;"><strong>Input:</strong> seats = [1,0,0,0]
...
<pre style="position: relative;"><strong>Input:</strong> seats = [0,1]
