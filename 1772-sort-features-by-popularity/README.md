...
<pre style="position: relative;"><strong>Input:</strong> features = ["cooler","lock","touch"], responses = ["i like cooler cooler","lock touch cool","locker like touch"]
...
<pre style="position: relative;"><strong>Input:</strong> features = ["a","aa","b","c"], responses = ["a","a aa","a a a a a","b a"]
