...
<pre style="position: relative;"><strong>Input:</strong> root = [3,5,1,6,2,0,8,null,null,7,4], nodes = [4,7]
...
<img alt="" src="https://assets.leetcode.com/uploads/2018/12/14/binarytree.png">
<pre style="position: relative;"><strong>Input:</strong> root = [3,5,1,6,2,0,8,null,null,7,4], nodes = [1]
...
<img alt="" src="https://assets.leetcode.com/uploads/2018/12/14/binarytree.png">
<pre style="position: relative;"><strong>Input:</strong> root = [3,5,1,6,2,0,8,null,null,7,4], nodes = [7,6,2,4]
